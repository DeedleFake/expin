defmodule Expin.Admins do
  ...
  alias Expin.Admins.{Admin, AdminToken, AdminNotifier}

  ## Database getters

  def admin_exists?(), do: Repo.exists?(Admin)
  ...
  ## Examples
      ...
      iex> deliver_admin_update_email_instructions(admin, current_email, &url(~p"/_/settings/confirm_email/#{&1})")
      {:ok, %{to: ..., body: ...}}
  ...
  ## Examples
      ...
      iex> deliver_admin_confirmation_instructions(admin, &url(~p"/_/confirm/#{&1}"))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_admin_confirmation_instructions(confirmed_admin, &url(~p"/_/confirm/#{&1}"))
  ...
  ## Examples
      ...
      iex> deliver_admin_reset_password_instructions(admin, &url(~p"/_/reset_password/#{&1}"))
      {:ok, %{to: ..., body: ...}}
