defmodule ExpinWeb.AdminAuth do
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ExpinWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def on_mount(:ensure_authenticated, _params, session, socket) do
    ...
    if socket.assigns.current_admin do
      ...
      socket =
        ...
        |> Phoenix.LiveView.redirect(to: ~p"/_/log_in")
  ...
  defp signed_in_path(_conn), do: ~p"/_/settings"
end
