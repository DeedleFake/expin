defmodule ExpinWeb.AdminAuthTest do
  use ExpinWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Expin.Admins
  alias ExpinWeb.AdminAuth
  import Expin.AdminsFixtures

  @remember_me_cookie "_expin_web_admin_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ExpinWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ExpinWeb.Endpoint.subscribe(live_socket_id)
