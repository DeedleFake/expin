defmodule Expin.AccessTokensTest do
  use Expin.DataCase
  ...
  describe "access_tokens" do
    ...
    import Expin.AccessTokensFixtures
    ...
    test "update_access_token/2 with valid data updates the access_token" do
      ...
      assert {:ok, %AccessToken{} = access_token} =
               AccessTokens.update_access_token(access_token, update_attrs)
    end
    ...
    test "update_access_token/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               AccessTokens.update_access_token(access_token, @invalid_attrs)
